...
CREATE TABLE products (
    ...
    direct_commission_percent DECIMAL(5, 2) NOT NULL CHECK (direct_commission_percent BETWEEN 0.00 AND 100.00),
    binary_commission_percent DECIMAL(5, 2) NOT NULL CHECK (binary_commission_percent BETWEEN 0.00 AND 100.00),
